...
func main() {
	...
	if githubSecret == "" && gitlabSecret == "" {
		log.Println("Warning: Neither GITHUB_WEBHOOK_SECRET nor GITLAB_WEBHOOK_SECRET was provided.")
	...
	//Create a context that listens for termination signals (Ctrl+C, Docker stop)
